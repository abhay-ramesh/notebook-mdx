...
import { remarkNotebook } from 'notebook-mdx/server'; /* [!code highlight] */

// ...
  remarkPlugins: [
    remarkNotebook, /* [!code highlight] */
  ],
// ...
```
...
import { notebookComponents } from 'notebook-mdx/client'; /* [!code highlight] */
