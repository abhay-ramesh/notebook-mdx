...
For Next.js projects, you **must** configure webpack to handle `.ipynb` files:
...
:::notebook{file="./examples/example-with-notebook-mdx.ipynb"}
:::

Without this configuration, you'll get import errors when trying to import `.ipynb` files.
