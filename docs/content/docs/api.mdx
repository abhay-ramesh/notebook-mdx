...
```mdx
<!-- Light theme -->
:::notebook{file="./demo.ipynb" theme="light" className="light-notebook"}
:::

<!-- Dark theme -->
:::notebook{file="./demo.ipynb" theme="dark" className="dark-notebook"}
:::
```
...
:::notebook{file="./interactive.ipynb" interactive showCellNumbers}
